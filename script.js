/**
*@var question переменная которая хранит наши вопросы
*/
...
/**
*@var answer переменная которая хранит ответы на вопросы
*/
...
/**
*@var key переменная которая хранит номер правильного ответа
*/
var key = [1, 3, 3, 2, 3, 1, 3, 2, 0, 1, 1, 3, 0, 1, 1];
/**
*@var level переменная которая хранит уровень игрока 
*/
var level = 0;
/**
*@var name переменная которая хранит имя игрока 
*/
var name = 'name';	
/**
*@var username переменная которая запоминает имя игрока
*/
